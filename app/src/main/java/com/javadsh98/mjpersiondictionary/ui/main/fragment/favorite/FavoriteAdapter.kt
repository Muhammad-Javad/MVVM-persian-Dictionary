...
class FavoriteAdapter (val callback: OnItemClickCallBack): RecyclerView.Adapter<FavoriteAdapter.FavoriteHolder>(){

    var words: List<Word> = listOf()

    fun setList(words: List<Word>){

        if(this@FavoriteAdapter.words.isEmpty()){
            this@FavoriteAdapter.words = words
            ...
            var result: DiffUtil.DiffResult = DiffUtil.calculateDiff(object : DiffUtil.Callback() {
                override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
                    ...
                    var oldWord = this@FavoriteAdapter.words[oldItemPosition]
                    return newWord.id == oldWord.id
                }
                override fun getOldListSize(): Int {
                    return this@FavoriteAdapter.words.size
                }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteHolder {
        ...
        return FavoriteHolder(root, callback)
    }
    ...
    class FavoriteHolder(var itemview: View, val callback: OnItemClickCallBack): RecyclerView.ViewHolder(itemview){
